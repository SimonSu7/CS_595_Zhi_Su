...
cpi: cpi.o  chkopts
	 ...
	 ${RM} cpi.o
hw3_zhisu: hw3_zhisu.o  chkopts
	 -${CLINKER} -o hw3_zhisu hw3_zhisu.o  ${PETSC_KSP_LIB}
	 ${RM} hw3_zhisu.o
e2:  e2.o  chkopts
	-${CLINKER} -o e2 e2.o  ${PETSC_KSP_LIB}
	${RM} e2.o
hw4_zhisu: hw4_zhisu.o  chkopts
	 -${CLINKER} -o hw4_zhisu hw4_zhisu.o  ${PETSC_KSP_LIB}
	 ${RM} hw4_zhisu.o
